<?php
/**
 * Modal: WordPress Developed Projects
 */
?>
...
<div id="modal-wordpress" class="modal-overlay">
  <div class="modal-content">
    ...
    <h3 data-pt="Projetos Desenvolvidos em WordPress" data-en="WordPress Developed Projects">
      WordPress Developed Projects
    </h3>
    ...
    <p data-pt="Estes são projetos de estudo onde criei temas do zero, praticando conceitos essenciais do WordPress, como hooks (ações e filtros), hierarquia de templates, além de conceitos avançados como custom post types, taxonomias personalizadas e desenvolvimento de plugins. O objetivo foi aprofundar o entendimento da arquitetura do WordPress e desenvolver temas funcionais e customizados."
      ...
      These are study projects where I created themes from scratch, practicing essential WordPress concepts like hooks (actions and filters), template hierarchy, as well as advanced concepts like custom post types, custom taxonomies and plugin development. The goal was to deepen my understanding of WordPress architecture and develop functional, customized themes.
    </p>
    ...
    <div class="modal-gallery">
      <div class="project">
        ...
        <a href="https://github.com/anamariarangel/playtheme" target="_blank" rel="noopener noreferrer">
          <img src="https://portfolio.anamariarangel.com.br/wp-content/uploads/2024/10/4.png" alt="Play Theme" data-pt="Play Theme" data-en="Play Theme">
        </a>
        <p>
          🔗 <a href="https://github.com/anamariarangel/playtheme" target="_blank" rel="noopener noreferrer" data-pt="Ver no GitHub" data-en="View on GitHub">View on GitHub</a>
        </p>
        <p>
          🔗 <a href="https://playtheme.anamariarangel.com.br" target="_blank" rel="noopener noreferrer" data-pt="Visite o site" data-en="Visit website">Visit website</a>
        </p>
      </div>
      ...
      <div class="project">
        ...
        <a href="https://github.com/anamariarangel/tarotheme" target="_blank" rel="noopener noreferrer">
          <img src="https://portfolio.anamariarangel.com.br/wp-content/uploads/2024/10/14.png" alt="Tarot Theme" data-pt="Tarot Theme" data-en="Tarot Theme">
        </a>
        <p>
          🔗 <a href="https://github.com/anamariarangel/tarotheme" target="_blank" rel="noopener noreferrer" data-pt="Ver no GitHub" data-en="View on GitHub">View on GitHub</a>
        </p>
        <p>
          🔗 <a href="https://tarotheme.anamariarangel.com.br" target="_blank" rel="noopener noreferrer" data-pt="Visite o site" data-en="Visit website">Visit website</a>
        </p>
      </div>
      ...
      <div class="project">
        ...
        <a href="https://portfolio.anamariarangel.com.br" target="_blank" rel="noopener noreferrer">
          <img src="https://portfolio.anamariarangel.com.br/wp-content/uploads/2025/07/Design-sem-nome-11.png" alt="My Portfolio" data-pt="Meu Portfolio" data-en="My Portfolio">
        </a>
        ...
        <p>
          🔗 <a href="https://github.com/anamariarangel/portfolio" target="_blank" rel="noopener noreferrer" data-pt="Ver no GitHub" data-en="View on GitHub">View on GitHub</a>
        </p>
      </div>
    </div>
